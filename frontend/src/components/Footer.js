...
const Footer = () => {
  ...
  // Добавляем обработчик для закрытия футера при нажатии на escape
  useEffect(() => {
        ...
        <div className="footer-container">
          ...
          <div className="footer-section" itemScope itemType="https://schema.org/Organization">
            ...
            <div className="social-links">
              <a href={settings.telegramLink || "https://t.me/yourname"} target="_blank" rel="noopener noreferrer" className="social-link telegram" onClick={(e) => e.stopPropagation()}>
              ...
              <a href={settings.whatsappLink || "https://wa.me/79999999999"} target="_blank" rel="noopener noreferrer" className="social-link whatsapp" onClick={(e) => e.stopPropagation()}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
